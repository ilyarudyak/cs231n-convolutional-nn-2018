...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        a, cache_ar = affine_relu_forward(X, W1, b1)
        scores, cache_a = affine_forward(a, W2, b2)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dhidden, dW2, db2 = affine_backward(dscores, cache_a)
        _, dW1, db1 = affine_relu_backward(dhidden, cache_ar)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        scores, cache[L] = affine_forward(out, self.params['W' + str(L)], self.params['b' + str(L)])
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
